...
var partOfSpeech = [adjectives, adverbs, articles, nouns, prepositions, verbs];
var candidate = [
  ...
  return function(allWords) {
    allWords.forEach(function(word) {
      candidateWords.forEach(function(candidateWord) {
        if (candidateWord === word.lookupValue) { //The return function checks every word in the object against every word in the candidate's db.
