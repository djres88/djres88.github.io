...
//Instead, starting with a list of the 5000 most common words in English, I build my own dictionary. Using this as a starting point, the program (specifically the "makeWordObjects.js" file) will automatically check for new words every time I scrape Twitter; the unrecognized words will be logged to the console, and I can choose to either (1) add them to the dictionary, (2) add them to the corrections list (if they're already in the dictionary and are only misspellings/tense differences), or (3) add them to the list of words to remove.
