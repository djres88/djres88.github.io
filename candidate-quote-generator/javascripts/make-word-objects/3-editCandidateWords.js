...
//List of candidates. The sentence constructor works better if all candidates are in one object (I can get a random candidate that way).
var candidates = {
  cruz: cruz,
  clinton: clinton,
  sanders: sanders,
